...
Route::post('{pagename}/{methodname}/{arg1?}',[AppController::class,'post'])->name('app.post');
Route::put('{pagename}/{methodname}/{arg1?}',[AppController::class,'post'])->name('app.post');
Route::delete('{pagename}/{methodname}/{arg1?}',[AppController::class,'post'])->name('app.post');
